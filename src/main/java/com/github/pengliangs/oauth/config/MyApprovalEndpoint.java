...
/**
 * @author pengliang on 2018-07-31 17:20
 *
 */
@RestController
...
public class MyApprovalEndpoint {
	...
	public ModelAndView getAccessConfirmation(Map<String, Object> model, HttpServletRequest request) throws Exception {
		...
		return new ModelAndView(new MySpelView(template), model);
	}
	...
	private static String SCOPE = "<li><div class='form-group'>%scope%: <input type='radio' name='%key%'"
			+ " value='true' checked>Approve</input> <input type='radio' name='%key%' value='false'>Deny</input></div></li>";
